            ...
            <form method="POST" action="{{ route('events.store') }}" x-data="{
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" id="title" name="title" class="bg-gray-800 text-gray-400 text-sm rounded-lg focus:ring-blue-500 w-full" placeholder="Event Title">
                        @error('title')
                    ...
                    <div>
                        ...
                        <select name="country_id" id="country_id" x-model="country" x-on:change="onCountryChange" class="bg-gray-800 text-gray-400 text-sm rounded-lg focus:ring-blue-500 w-full">
                    ...
                    <div>
                        ...
                        <input type="text" id="address" name="address" class="bg-gray-800 text-gray-400 text-sm rounded-lg focus:ring-blue-500 w-full" placeholder="Event Address">
                        @error('address')
                            <div class="text-sm text-red-400">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" id="start_date" name="start_date" class="bg-gray-800 text-gray-400 text-sm rounded-lg focus:ring-blue-500 w-full">
                        @error('start_date')
                            <div class="text-sm text-red-400">{{ $message }}</div>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="date" id="end_date" name="end_date" class="bg-gray-800 text-gray-400 text-sm rounded-lg focus:ring-blue-500 w-full">
                        @error('end_date')
                            <div class="text-sm text-red-400">{{ $message }}</div>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="time" id="start_time" name="start_time" class="bg-gray-800 text-gray-400 text-sm rounded-lg focus:ring-blue-500 w-full">
                        @error('start_time')
                            <div class="text-sm text-red-400">{{ $message }}</div>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="number" id="num_tickets" name="num_tickets" class="bg-gray-800 text-gray-400 text-sm rounded-lg focus:ring-blue-500 w-full" value="1">
                        @error('num_tickets')
                            <div class="text-sm text-red-400">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea rows="4" id="description" name="description" class="block p-2.5 w-full text-sm text-gray-400 bg-gray-800 rounded-lg focus:ring-blue-500" placeholder="Write your thoughts here..."></textarea>
                        @error('description')
                            <div class="text-sm text-red-400">{{ $message }}</div>
                        @enderror
                    </div>
